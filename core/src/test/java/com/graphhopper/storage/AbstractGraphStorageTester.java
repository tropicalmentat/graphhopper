...
public abstract class AbstractGraphStorageTester {
    ...
    public void testCreateLocation() {
        graph = createGHStorage();
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(3, 1).setDistance(50));
        assertEquals(1, getCountOut(1));

        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(1, 2).setDistance(100));
    ...
    public void testEdges() {
        graph = createGHStorage();
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(2, 1).setDistance(12));
        assertEquals(1, getCountOut(2));

        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(2, 3).setDistance(12));
        assertEquals(1, getCountOut(1));
    ...
    public void testUnidirectional() {
        ...
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 2).setDistance(12));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 11).setDistance(12));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(11, 1).setDistance(12));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 12).setDistance(12));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(3, 2).setDistance(112));
    ...
    public void testUpdateUnidirectional() {
        ...
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(2, 3).setDistance(112));
    ...
    public void testCopyProperties() {
        graph = createGHStorage();
        EdgeIteratorState edge = GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 3).setDistance(10)).setName("testing").setWayGeometry(Helper.createPointList(1, 2));

        EdgeIteratorState newEdge = GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 3).setDistance(10));
    ...
    public void testGetLocations() {
        ...
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 1).setDistance(10));
        assertEquals(2, graph.getNodes());

        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 2).setDistance(10));
    ...
    protected void initExampleGraph(Graph g) {
        ...
        na.setNode(4, 2, 1);
        na.setNode(5, 7, 5);
        GHUtility.setAccess(true, true, carAccessEnc, g.edge(0, 1).setDistance((12)));
        GHUtility.setAccess(true, true, carAccessEnc, g.edge(0, 2).setDistance((212)));
        GHUtility.setAccess(true, true, carAccessEnc, g.edge(0, 3).setDistance((212)));
        GHUtility.setAccess(true, true, carAccessEnc, g.edge(0, 4).setDistance((212)));
        GHUtility.setAccess(true, true, carAccessEnc, g.edge(0, 5).setDistance((212)));
    }
    ...
    public void testDirectional() {
        graph = createGHStorage();
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(1, 2).setDistance(12));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(2, 3).setDistance(12));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(3, 4).setDistance(12));
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(3, 5).setDistance(12));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(6, 3).setDistance(12));
    ...
    public void testDozendEdges() {
        ...
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 3).setDistance(13));
        assertEquals(2, getCountAll(1));

        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 4).setDistance(14));
        assertEquals(3, getCountAll(1));

        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 5).setDistance(15));
        assertEquals(4, getCountAll(1));

        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 6).setDistance(16));
        assertEquals(5, getCountAll(1));

        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 7).setDistance(16));
        assertEquals(6, getCountAll(1));

        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 8).setDistance(16));
        assertEquals(7, getCountAll(1));

        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(1, 9).setDistance(16));
    ...
    public void testCheckFirstNode() {
        ...
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 1).setDistance(12));
        assertEquals(1, getCountAll(1));
    }
    ...
    public void testFlags() {
        ...
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(2, 3)).setDistance(10)
    ...
    public void testEdgeProperties() {
        graph = createGHStorage();
        EdgeIteratorState iter1 = GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 1).setDistance(10));
        EdgeIteratorState iter2 = GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 2).setDistance(20));
    ...
    public void testCreateDuplicateEdges() {
        ...
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(2, 1).setDistance(12));
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(2, 3).setDistance(12));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(2, 3).setDistance(13));
        ...
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(3, 2).setDistance(14));
    ...
    public void testIdenticalNodes() {
        graph = createGHStorage();
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 0).setDistance(100));
    ...
    public void testIdenticalNodes2() {
        graph = createGHStorage();
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(0, 0).setDistance(100));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(0, 0).setDistance(100));
    ...
    public void testEdgeReturn() {
        ...
        GHUtility.setAccess(true, false, carAccessEnc, iter);
    ...
    public void testPillarNodes() {
        ...
        GHUtility.setAccess(true, false, carAccessEnc, edge);
    ...
    public void testFootMix() {
        graph = createGHStorage();
        GHUtility.setAccess(true, true, footAccessEnc, graph.edge(0, 1).setDistance((10)));
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 2).setDistance((10)));
        EdgeIteratorState edge = graph.edge(0, 3).setDistance(10);
        GHUtility.setAccess(true, true, footAccessEnc, edge);
        GHUtility.setAccess(true, true, carAccessEnc, edge);
    ...
    public void testGetAllEdges() {
        graph = createGHStorage();
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 1).setDistance(2));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(3, 1).setDistance(1));
        GHUtility.setAccess(true, false, carAccessEnc, graph.edge(3, 2).setDistance(1));
    ...
    public void testStringIndex() {
        ...
        EdgeIteratorState iter2 = GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 1).setDistance(10));
    ...
    public void testDetachEdge() {
        graph = createGHStorage();
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 1).setDistance(2));
        GHUtility.setAccess(true, false, carAccessEnc, GHUtility.setAccess(true, true, carAccessEnc, graph.edge(0, 2).setDistance(2)).setWayGeometry(Helper.createPointList(1, 2, 3, 4)));
        GHUtility.setAccess(true, true, carAccessEnc, graph.edge(1, 2).setDistance(2));
        ...
        GHUtility.setAccess(true, false, carAccessEnc, GHUtility.setAccess(true, true, carAccessEnc, graph.edge(3, 3).setDistance(2)));
