...
public class EdgeBasedNodeContractorTest {
    ...
    private void initialize() {
        ...
        chConfigs = Arrays.asList(
                CHConfig.edgeBased("p1", new DistanceWeighting(accessEnc, new DefaultTurnCostProvider(turnCostEnc, graph.getTurnCostStorage()))),
                CHConfig.edgeBased("p2", new DistanceWeighting(accessEnc, new DefaultTurnCostProvider(turnCostEnc, graph.getTurnCostStorage(), 60)))
        );
    }
