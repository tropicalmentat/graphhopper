...
public class CHQueryWithTurnCostsTest {
    ...
    public void testFindPathWithTurnCosts_bidirected_no_shortcuts_smallGraph(Fixture f) {
        ...
        // 1 -- 0 -- 2
        f.graph.edge(1, 0).setDistance(3).set(f.accessEnc, true, true);
        f.graph.edge(0, 2).setDistance(5).set(f.accessEnc, true, true);
    ...
    public void testFindPathWithTurnCosts_bidirected_no_shortcuts(Fixture f) {
        // 0 -- 2 -- 4 -- 6 -- 5 -- 3 -- 1
        f.graph.edge(0, 2).setDistance(3).set(f.accessEnc, true, true);
        f.graph.edge(2, 4).setDistance(2).set(f.accessEnc, true, true);
        f.graph.edge(4, 6).setDistance(7).set(f.accessEnc, true, true);
        f.graph.edge(6, 5).setDistance(9).set(f.accessEnc, true, true);
        f.graph.edge(5, 3).setDistance(1).set(f.accessEnc, true, true);
        f.graph.edge(3, 1).setDistance(4).set(f.accessEnc, true, true);
    ...
    public void testFindPathWithTurnCosts_loopShortcutBwdSearch(Fixture f) {
        ...
        //            \ /
        // 0 - 7 - 8 - 4 - 6 - 5
        f.graph.edge(0, 7).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(7, 8).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(8, 4).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(4, 1).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(1, 3).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(3, 2).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(2, 4).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(4, 6).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(6, 5).setDistance(1).set(f.accessEnc, true, false);
    ...
    public void testFindPathWithTurnCosts_directed_single_shortcut(Fixture f) {
        ...
        //  /   \2/   \
        // 1     0     4
        f.graph.edge(1, 2).setDistance(4).set(f.accessEnc, true, false);
        f.graph.edge(2, 0).setDistance(2).set(f.accessEnc, true, false);
        f.graph.edge(0, 3).setDistance(3).set(f.accessEnc, true, false);
        f.graph.edge(3, 4).setDistance(2).set(f.accessEnc, true, false);
    ...
    public void testFindPathWithTurnCosts_directed_single_shortcut_fwdSearchStopsQuickly(Fixture f) {
        ...
        //    / \
        // 1-2-s-3-4
        f.graph.edge(1, 2).setDistance(2).set(f.accessEnc, true, false);
        f.graph.edge(2, 0).setDistance(3).set(f.accessEnc, true, false);
        f.graph.edge(0, 3).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(3, 4).setDistance(3).set(f.accessEnc, true, false);
        f.freeze();
    ...
    public void testFindPathWithTurnCosts_directed_two_shortcuts(Fixture f) {
        ...
        //  /   \2/   \
        // 2     1     4
        f.graph.edge(2, 3).setDistance(4).set(f.accessEnc, true, false);
        f.graph.edge(3, 1).setDistance(2).set(f.accessEnc, true, false);
        f.graph.edge(1, 0).setDistance(3).set(f.accessEnc, true, false);
        f.graph.edge(0, 4).setDistance(2).set(f.accessEnc, true, false);
    ...
    public void testFindPath_directConnectionIsNotTheBestPath(Fixture f) {
        ...
        // v         v
        // 2 -> 3 -> 1
        f.graph.edge(0, 2).setDistance(3).set(f.accessEnc, true, false);
        f.graph.edge(2, 3).setDistance(2).set(f.accessEnc, true, false);
        f.graph.edge(3, 1).setDistance(9).set(f.accessEnc, true, false);
        f.graph.edge(0, 1).setDistance(50).set(f.accessEnc, true, false);
    ...
    public void testFindPath_downwardSearchRunsIntoTarget(Fixture f) {
        ...
        //   \  |
        //    <-2<-3
        f.graph.edge(1, 0).setDistance(9).set(f.accessEnc, true, false);
        f.graph.edge(2, 0).setDistance(14).set(f.accessEnc, true, false);
        f.graph.edge(2, 1).setDistance(2).set(f.accessEnc, true, false);
        f.graph.edge(3, 2).setDistance(9).set(f.accessEnc, true, false);
        f.freeze();
    ...
    public void testFindPath_incomingShortcut(Fixture f) {
        ...
        // v/
        // 3 -> 2
        f.graph.edge(0, 1).setDistance(9).set(f.accessEnc, true, true);
        f.graph.edge(0, 3).setDistance(14).set(f.accessEnc, true, false);
        f.graph.edge(3, 2).setDistance(9).set(f.accessEnc, true, false);
        f.freeze();
        f.setIdentityLevels();
    ...
    public void testFindPathWithTurnCosts_fwdBwdSearchesMeetWithUTurn(Fixture f) {
        ...
        //       |
        // 0 --- 2 --- 1
        f.graph.edge(0, 2).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(2, 3).setDistance(2).set(f.accessEnc, true, true);
        f.graph.edge(2, 1).setDistance(3).set(f.accessEnc, true, false);
    ...
    private void checkUTurnNotBeingUsed(Fixture f, boolean toLowerLevelNode) {
        ...
        f.graph.edge(1, nodeA).setDistance(4).set(f.accessEnc, true, false);
        f.graph.edge(0, 3).setDistance(4).set(f.accessEnc, true, false);
        f.graph.edge(nodeB, 2).setDistance(1).set(f.accessEnc, true, false);
        final EdgeIteratorState e3toB = f.graph.edge(3, nodeB).setDistance(2).set(f.accessEnc, true, false);
        final EdgeIteratorState e3toA = f.graph.edge(3, nodeA).setDistance(1).set(f.accessEnc, true, true);
        f.freeze();
    ...
    public void testFindPathWithTurnCosts_loop(Fixture f) {
        ...
        //       |/
        // 0 --- 2 --- 1
        final EdgeIteratorState edge1 = f.graph.edge(0, 2).setDistance(4).set(f.accessEnc, true, false);
        final EdgeIteratorState edge2 = f.graph.edge(2, 3).setDistance(1).set(f.accessEnc, true, true);
        final EdgeIteratorState edge3 = f.graph.edge(3, 2).setDistance(7).set(f.accessEnc, true, false);
        final EdgeIteratorState edge4 = f.graph.edge(2, 1).setDistance(3).set(f.accessEnc, true, false);
    ...
    public void testFindPath_loopIsRecognizedAsIncomingEdge(Fixture f) {
        ...
        //     \ /
        // 0 -- 3 -- 2 -- 1
        EdgeIteratorState edge0 = f.graph.edge(0, 3).setDistance(1).set(f.accessEnc, true, true);
        EdgeIteratorState edge1 = f.graph.edge(3, 3).setDistance(1).set(f.accessEnc, true, false);
        EdgeIteratorState edge2 = f.graph.edge(3, 2).setDistance(1).set(f.accessEnc, true, true);
        EdgeIteratorState edge3 = f.graph.edge(2, 1).setDistance(1).set(f.accessEnc, true, false);
    ...
    public void testFindPath_shortcutLoopIsRecognizedAsIncomingEdge(Fixture f) {
        ...
        //          \ /
        // 3 -- 4 -- 2 -- 1
        EdgeIteratorState edge0 = f.graph.edge(3, 4).setDistance(1).set(f.accessEnc, true, true);
        EdgeIteratorState edge1 = f.graph.edge(4, 2).setDistance(1).set(f.accessEnc, true, true);
        EdgeIteratorState edge2 = f.graph.edge(2, 0).setDistance(1).set(f.accessEnc, true, false);
        EdgeIteratorState edge3 = f.graph.edge(0, 2).setDistance(1).set(f.accessEnc, true, false);
        EdgeIteratorState edge4 = f.graph.edge(2, 1).setDistance(1).set(f.accessEnc, true, false);
        f.setRestriction(edge1, edge4, 2);
        f.freeze();
    ...
    public void testFindPathWithTurnRestriction_single_loop(Fixture f) {
        ...
        //     2
        f.graph.edge(3, 4).setDistance(2).set(f.accessEnc, true, false);
        f.graph.edge(4, 0).setDistance(1).set(f.accessEnc, true, true);
        f.graph.edge(0, 1).setDistance(3).set(f.accessEnc, true, false);
        f.graph.edge(4, 1).setDistance(5).set(f.accessEnc, true, true);
        f.graph.edge(4, 2).setDistance(4).set(f.accessEnc, true, false);
    ...
    public void testFindPathWithTurnRestriction_double_loop(Fixture f) {
        ...
        //     5
        final EdgeIteratorState e0to1 = f.graph.edge(0, 1).setDistance(2).set(f.accessEnc, true, true);
        final EdgeIteratorState e1to6 = f.graph.edge(1, 6).setDistance(1).set(f.accessEnc, true, true);
        final EdgeIteratorState e0to6 = f.graph.edge(0, 6).setDistance(4).set(f.accessEnc, true, true);
        final EdgeIteratorState e2to6 = f.graph.edge(2, 6).setDistance(5).set(f.accessEnc, true, true);
        final EdgeIteratorState e2to3 = f.graph.edge(2, 3).setDistance(3).set(f.accessEnc, true, true);
        final EdgeIteratorState e3to6 = f.graph.edge(3, 6).setDistance(2).set(f.accessEnc, true, true);
        final EdgeIteratorState e6to7 = f.graph.edge(7, 6).setDistance(1).set(f.accessEnc, true, true);
        final EdgeIteratorState e4to7 = f.graph.edge(7, 4).setDistance(3).set(f.accessEnc, true, true);
        final EdgeIteratorState e5to7 = f.graph.edge(7, 5).setDistance(2).set(f.accessEnc, true, true);
    ...
    public void testFindPathWithTurnRestriction_two_different_loops(Fixture f) {
        ...
        //     2
        f.graph.edge(0, 1).setDistance(2).set(f.accessEnc, true, false);
        f.graph.edge(1, 5).setDistance(1).set(f.accessEnc, true, true);
        f.graph.edge(5, 0).setDistance(1).set(f.accessEnc, true, false);
        f.graph.edge(5, 4).setDistance(5).set(f.accessEnc, true, false);
        f.graph.edge(5, 6).setDistance(3).set(f.accessEnc, true, true);
        f.graph.edge(6, 4).setDistance(4).set(f.accessEnc, true, true);

        f.graph.edge(3, 6).setDistance(3).set(f.accessEnc, true, false);
        f.graph.edge(6, 2).setDistance(4).set(f.accessEnc, true, false);
