...
public class Car4WDTagParser extends CarTagParser {
    ...
    public Car4WDTagParser(EncodedValueLookup lookup, PMap properties) {
        this(
                lookup.getBooleanEncodedValue(AccessEV.key(properties.getString("name", "car4wd"))),
                lookup.getDecimalEncodedValue(AverageSpeed.key(properties.getString("name", "car4wd"))),
