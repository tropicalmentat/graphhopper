...
public class FootTagParser extends VehicleTagParser {
    ...
    public FootTagParser(EncodedValueLookup lookup, PMap properties) {
        this(
                lookup.getBooleanEncodedValue(AccessEV.key(properties.getString("name", "foot"))),
                lookup.getDecimalEncodedValue(AverageSpeed.key(properties.getString("name", "foot"))),
                lookup.getDecimalEncodedValue(Priority.key(properties.getString("name", "foot"))),
