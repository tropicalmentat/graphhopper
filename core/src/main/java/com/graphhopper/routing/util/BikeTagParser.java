...
public class BikeTagParser extends BikeCommonTagParser {
    ...
    public BikeTagParser(EncodedValueLookup lookup, PMap properties) {
        this(
                lookup.getBooleanEncodedValue(AccessEV.key(properties.getString("name", "bike"))),
                lookup.getDecimalEncodedValue(AverageSpeed.key(properties.getString("name", "bike"))),
                lookup.getDecimalEncodedValue(Priority.key(properties.getString("name", "bike"))),
