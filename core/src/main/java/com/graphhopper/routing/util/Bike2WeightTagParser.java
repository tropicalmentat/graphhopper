...
public class Bike2WeightTagParser extends BikeTagParser {
    ...
    public Bike2WeightTagParser(EncodedValueLookup lookup, PMap properties) {
        this(
                lookup.getBooleanEncodedValue(AccessEV.key(properties.getString("name", "bike2"))),
                lookup.getDecimalEncodedValue(AverageSpeed.key(properties.getString("name", "bike2"))),
                lookup.getDecimalEncodedValue(Priority.key(properties.getString("name", "bike2"))),
